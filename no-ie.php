...
<div style="width:100%;height:20px;"></div><img src="/no-ie/no-ie.png" class="no-ie" alt="NoIE" /><div style="width:100%;height:7px;"></div><h1 class="text">{$strings->title}</h1><p class="text">{$strings->description}</p><p class="text"><a href="https://github.com/natanhell/NoIE">NoIE is free, download for your website here.</a></p><div style="width:100%;height:20px;"></div></div></div></body></html>
EOT;
    }
}
